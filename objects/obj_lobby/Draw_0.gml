if(state == 0)
{
	...
	switch(obj_netclient.chance){
		case 0:
			scr_text_spr(1, 40, $"\\exe chances~: {obj_netclient.chance}% &how");
			break;
		case 100:
			scr_text_spr(1, 40, $"\\exe chances~: |{obj_netclient.chance}~% wtf stop cheating");
			break;
		case 101:
			scr_text_spr(1, 40, $"\\exe chances~: {obj_netclient.chance}% i want big burgr moment");
			break;
		case 102:
			scr_text_spr(1, 40, $"\\exe chances~: {obj_netclient.chance}~% stop");
			break;
		default:
			scr_text_spr(1, 40, $"\\exe chances~: {obj_netclient.chance}%");
			break;
	}
}
else if(state == 1)
